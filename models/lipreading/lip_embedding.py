...
import numpy as np
import json
from models.lipreading.resnet import ResNet, BasicBlock
from models.lipreading.resnet1D import ResNet1D, BasicBlock1D
from models.lipreading.shufflenetv2 import ShuffleNetV2
from models.lipreading.tcn import MultibranchTemporalConvNet, TemporalConvNet
from models.lipreading.densetcn import DenseTemporalConvNet
from models.lipreading.swish import Swish
...
def get_model_from_json(config_json_fpath: str, device = torch.device("cpu")):
    args_loaded = json.load(open(config_json_fpath, "r"))
