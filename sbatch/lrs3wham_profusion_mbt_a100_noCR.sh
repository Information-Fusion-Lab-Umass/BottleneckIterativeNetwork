...
torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_lrs3wham_prombt_noCR.py --config avlit.yaml --exp_version prombt12_wham_reg0_f256_a100_noCR --recover_weight 0 --batch_size 16  --num_blocks 12 --fusion_dim 256