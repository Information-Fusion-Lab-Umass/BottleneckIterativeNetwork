...
export NGPU=8
export MASTER_PORT=44128

torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_ntcd_prombt.py --config avlit.yaml --exp_version prombt_ntcd_reg0_a100_b20_f256 --recover_weight 0 --batch_size 4 --num_blocks 20 --fusion_dim 256