...
torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_lrs3wham_prombt_noC.py --config avlit.yaml --exp_version prombt12_wham_reg0_f512_rtx_noC --recover_weight 0 --batch_size 16  --num_blocks 12 --fusion_dim 512