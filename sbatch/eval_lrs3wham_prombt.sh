...
torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/eval_lrs3wham_prombt.py --config avlit.yaml --exp_version prombt2_wham_reg0_a100_f256 --recover_weight 0 --batch_size 16 --num_blocks 12 --fusion_dim 256