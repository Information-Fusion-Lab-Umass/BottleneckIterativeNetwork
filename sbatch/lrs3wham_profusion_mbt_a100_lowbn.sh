...
export NGPU=8
export MASTER_PORT=44177

torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_lrs3wham_prombt_lowbn.py --config avlit.yaml --exp_version prombt4_wham_reg0_f8_a100 --recover_weight 0 --batch_size 16  --num_blocks 4 --fusion_dim 8