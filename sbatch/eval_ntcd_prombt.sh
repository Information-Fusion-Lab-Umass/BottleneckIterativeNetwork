...
torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/eval_ntcd_prombt.py --config avlit.yaml --exp_version prombt12_ntcd_reg0_a100_f512 --recover_weight 0 --batch_size 16 --num_blocks 12 --fusion_dim 512