...
torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_lrs3wham_rtfs.py --config rtfs12.yaml --exp_version lrs3wham_b12_a100 --batch_size 8 --recover_weight 0