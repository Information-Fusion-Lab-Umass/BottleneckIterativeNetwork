...
export NGPU=8
export MASTER_PORT=44125

torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_ntcd_iia.py --config iia12.yaml --exp_version ntcd_b16_a100 --batch_size 8 --recover_weight 0 --num_blocks 16