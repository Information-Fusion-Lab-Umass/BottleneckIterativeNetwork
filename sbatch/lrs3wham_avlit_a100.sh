...
torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_lrs3wham_avlit_ff.py --config avlit.yaml --exp_version avlit_wham_reg0_a100 --recover_weight 0 --batch_size 16