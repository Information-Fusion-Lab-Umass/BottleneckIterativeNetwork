...
torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_ntcd_videoae_distributed.py --config video_ae.yaml --exp_version ntcd_e3000_lr1e-2 --batch_size 32