...
torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_ntcd_avlit.py --config avlit.yaml --exp_version avlit_ntcd_reg0_a100 --recover_weight 0 --batch_size 16