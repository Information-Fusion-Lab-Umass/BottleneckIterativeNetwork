...
export NGPU=8
export MASTER_PORT=44126

torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_lrs3wham_iia.py --config iia12.yaml --exp_version lrs3wham_b16_a100 --batch_size 16 --recover_weight 0 --num_blocks 16