...
export NGPU=8
export MASTER_PORT=44140

torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_lrs3wham_prombt.py --config avlit.yaml --exp_version prombt2_wham_reg0_2080exit_f256 --recover_weight 0 --batch_size 16 --num_blocks 2 --fusion_dim 256