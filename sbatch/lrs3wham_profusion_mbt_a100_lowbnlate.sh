...
export NGPU=8
export MASTER_PORT=44187

torchrun --nproc_per_node $NGPU --master_port=$MASTER_PORT scripts/run_lrs3wham_prombt_lowbnlate.py --config avlit.yaml --exp_version prombt4_wham_reg0_f8_a100_late --recover_weight 0 --batch_size 16  --num_blocks 4 --fusion_dim 8