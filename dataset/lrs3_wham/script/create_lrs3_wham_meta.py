...
def generate_lrs3_wham_mixture_meta(split="train", lrs3_duration=2000, sample_rate=16000):
    """
    :param split:
    ...
    for idx, row in wham_meta.iterrows():
        wham_len[row["utterance_id"]] = {"total_duration": row["time_duration"], "last_stop": 0.0}
    ...
    for idx, row in lrs3_meta.iterrows():
...
if __name__ == "__main__":
    ...
    generate_lrs3_wham_mixture_meta("train", lrs3_duration=2000)

    print("generate val")
    # generate_wham_len_meta("cv")
    generate_lrs3_wham_mixture_meta("val", lrs3_duration=2000)

    print("generate test")
    # generate_wham_len_meta("tt")
    generate_lrs3_wham_mixture_meta("test", lrs3_duration=2000)
